        ...
        <div className="max-w-2xl mx-auto px-6 py-24 text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-ink-mute max-w-md mx-auto">
              Tab uses your Solana wallet to identify you and to settle debts privately. Connect to
              see your dashboard.
            </p>
          </div>
    ...
    <>
      ...
      <div className="max-w-5xl mx-auto px-6 py-12 space-y-12">
        <header className="space-y-3">
          <div className="eyebrow text-ink-mute">Dashboard</div>
              ...
              <Receipt>
                {youOwe.map((d, i) => (
                  <PendingRow
                    ...
                    counterpartyWallet={d.toMember.wallet}
              ...
              <Receipt>
                {owedToYou.map((d, i) => (
                  <PendingRow
                    ...
                    counterpartyWallet={d.fromMember.wallet}
                    groupName={d.group.name}
                    groupId={d.group.id}
                    amount={d.amountBase}
                    direction="owed-to"
          ...
          {recentActivity.length === 0 ? (
            ...
            <div className="divide-y divide-dashed divide-paper-rim border-y border-dashed border-paper-rim">
              {recentActivity.map((entry) => {
                ...
                const youInvolved =
                  s.fromMemberId === group.members.find((m) => m.wallet === myWallet)?.id ||
                  s.toMemberId === group.members.find((m) => m.wallet === myWallet)?.id;
                return (
  ...
  return (
    <div className="group flex items-center justify-between py-3.5 border-b border-dashed border-paper-rim last:border-0">
      ...
      <div className="flex items-center gap-3 shrink-0">
        ...
        {settleHref && (
          <Link href={settleHref} className="md:opacity-0 md:group-hover:opacity-100 transition-opacity">
